...
import { textAnimate } from "@/app/_lib/gsap/helpers";
...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    gsap.set(reveal.current, { height: "2px" });
    ...
    tl.to(
      ...
      .to(buttonGroupRef.current, textAnimate, "-=0.3");
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex-1 min-h-[300px] max-h-[700px] overflow-hidden">
        <div ref={wrapper} className="relative w-full h-full opacity-0">
